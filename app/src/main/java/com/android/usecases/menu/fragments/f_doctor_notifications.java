...
import com.android.java.app.petcoloria.databinding.FDoctorNotificationsBinding;
...
public class f_doctor_notifications extends Fragment {

    private dates_adapter mAdapter;
    private FirebaseAuth authProfile;
    private ArrayList<date> dateList = new ArrayList<>();
    DatabaseReference mDatabase;
    public f_doctor_notifications() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        dateList.clear();
        FDoctorNotificationsBinding binding = FDoctorNotificationsBinding.inflate(inflater,container,false);
        ...
        binding.notiList.setLayoutManager(new LinearLayoutManager(getContext()));
    ...
    private void getDatesFromFirebase(FirebaseUser f_user, FDoctorNotificationsBinding binding){
        dateList.clear();
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    for (DataSnapshot dt: snapshot.getChildren()) {
                        ...
                        if(id.equals(userID)&&request.equals("pendiente")){
                    ...
                    mAdapter = new dates_adapter(dateList, R.layout.element_list_date, 2);
                    binding.notiList.setAdapter(mAdapter);
                }
            }
            @Override
